...
class job2Adj
{  
    public String[] jobs = {"Warrior","Paladin","Wizard","Shopkeeper","Courier","Archaeologist","Scribe","Imagineer","Priest","Gardener","Scribne","Messenger","Blacksmith","Metallurgist","Dancer","Scout","Familiar Caretaker","Beast Master","Fisher","hunter","Healer","Nurse","Guard","Scientist",
    ...
    public String[] traits = {"Caring","Aggressive","Compassionate","Accessible","Active","Adaptable","Admirable","Adventurous","Agreeable","Alert","Allocentric","Amiable","Anticipative","Appreciative","Articulate","Aspiring","Athletic","Attractive","Balanced","Benevolent","Brilliant","Calm","Capable",
...
public static void main(String[] args)
  { 
    ...
    Rextester jobmaker = new Rextester(); 
     jobmaker.getThing(20);
  }
...
public void getThing(int num) {
    ...
    for(int i = 0; i<num; i++) {
       ranJob = (int)(Math.random() * jobs.length);
       ranTrait = (int)(Math.random() * traits.length);
           job = jobs[ranJob];
        trait1 = traits[ranTrait];
        ranTrait = (int)(Math.random() * traits.length);
        trait2 = traits[ranTrait];
        
        System.out.println(job+": "+trait1+", "+trait2);
        System.out.println();
